...
class Address:
    ...
    #门牌号（赋值与提取）
    def setHouse_number(self,house_number):
        self.__house_number =house_number
    def getHouse_number(self):
        return self.__house_number

#银行开户类
class Account_opening(Address):
    __account_number = random.randint(10000000, 99999999)
    __user_name = None
    __password = None
    __bank_name = "中国工商银行"
    # 账户余额
    ...
    def add_user(self):
        ...
        if data1[0][0] >= 100:
            ...
            par3 = [self.__account_number,self.__user_name ,self.__password ,super().getCountry(),
                    super().getProvince(),super().getStreet(),super().getHouse_number() ,self.__money ,self.__bank_name]
            ...
            # 每个元素都可传入%
            print(info % (
                self.__user_name,self.__account_number ,super().getCountry() ,super().getProvince() ,
                super().getStreet() ,super().getHouse_number() ,self.__money,self.__bank_name))
            return 1


#存钱类
class Deposit_category(Account_opening):
    # 定义存钱函数
    # paremeter1 = 用户的账号,parameter2 = 存取的金额
    def save_money(self,parameter1, parameter2):
        # 定义SQL查找语句
...
#取钱类
class Withdrawal_category:
    # 定义取钱函数
    # parameter1 用户的账号 parameter2 用户密码 parameter3 取钱金额
    def withdraw_money(self,parameter1, parameter2, parameter3):
        # 查询用户账号
...
class Transfer_type:
    ...
    # parameter4 转出的金额
    def transfer_accounts(self,parameter1, parameter2, parameter3, parameter4):
        # 查询转出账号
            ...
            if data1[0][0] == parameter1 and data1[0][2] == parameter3:
                if data1[0][7] > parameter4:
                    ...
                    info = '''
                                                    ...
                                                    '''
                    print(
                        info % (parameter1, parameter2, parameter4, parameter4, data5[0][7], data6[0][7], data1[0][9]))
...
class Query_class:
    ...
    def query_account(self,parameter1,parameter2):
        # 查询账号
        ...
        if data1[0][0] == parameter1:
            if data1[0][2] == parameter2:
                ...
                # 每个元素都可传入%
                print(info % (
                    data1[0][0], data1[0][1], data1[0][7], data1[0][3],
...
#销户类
class Account_cancellation:
    # 定义销户函数
    # parameter1 = 账号,parameter2 = 密码  parameter3 = 用户名
    def account_cancellation(self,parameter1,parameter2,parameter3):
        # 定义SQL查询语句
...
#各类对象实例化
#提示类实例化
tips = Prompt_information()
#开户类实例化
open_an_account = Account_opening()
#存款类实例化
deposit = Deposit_category()
#取款类实例化
withdraw_money = Withdrawal_category()
#转账类实例化
transfer_accounts = Transfer_type()
#查询个人信息类实例化
query_information = Query_class()
#销户类实例化
...
while True:
    ...
    if choice == "1":
        ...
        open_an_account.setUser_name(user_name)
        open_an_account.setPassword(password)
        open_an_account.setCountry(country)
        open_an_account.setProvince(province)
        open_an_account.setStreet(street)
        open_an_account.setHouse_number(house_number)
        result1 = open_an_account.add_user()
        print(result1)
        print()
    elif choice == "2":
        print("存钱")
        ...
        result2 =deposit.save_money(account_number2,monetary_limit)
        print(result2)
        print()
    elif choice == "3":
        print("取钱")
        ...
        result3 = withdraw_money.withdraw_money(account_number3,password3,withdrawal_amount3)
        print(result3)
        print()
    elif choice == "4":
        print("转账")
        ...
        result4 = transfer_accounts.transfer_accounts(transfer_out_account4,transfer_to_account4,
        ...
        query_information.query_account(account_number5,user_password5)
        print()
    elif choice == "6":
        account_number6 = int(input("请输入账号："))
        user_password6 = int(input("请输入用户密码："))
        user_name6 = input("请输入用户名：")
        result6 = account_cancellation.account_cancellation(account_number6,user_password6,user_name6)
        print(result6)
        print()
    elif choice == "7":
        print("退出系统")
